...
fun quadraticEquationRoot(a: Double, b: Double, c: Double) =
    (-b + sqrt1(discriminant(a, b, c))) / (2 * a)
...
fun quadraticRootProduct(a: Double, b: Double, c: Double): Double {
    val sd = sqrt1(discriminant(a, b, c))
    val x1 = (-b + sd) / (2 * a)
    val x2 = (-b - sd) / (2 * a)
 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = kotlin.math.sqrt(sqr(x2 - x1) + sqr(y2 - y1))
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (initial * (1 + percent * 0.01).pow(3)).toDouble()
