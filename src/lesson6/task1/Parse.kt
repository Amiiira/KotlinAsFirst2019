...
fun dateDigitToStr(digital: String): String {
    ...
    return try {
        if (parts.size == 3) {
            ...
            if (month !in 1..12 || daysInMonth(month, parts[2].toInt()) < parts[0].toInt() || parts.isEmpty()) return ""
            else String.format("%d %s %d", parts[0].toInt(), months[month - 1], parts[2].toInt())
        } else ""
